    ...
    return (
        <div className="relative inline-block text-left">
            ...
            <img
                ...
                className="w-7 h-7 sm:w-9 sm:h-9 md:w-10 md:h-10 rounded-full cursor-pointer 
                ...
                >
                    ...
                    <div className="flex items-center space-x-3">
                        <img
                            ...
                            alt={userData?.name || "User"}
                            className="w-14 h-14 sm:w-16 sm:h-16 rounded-full border-2 border-gray-300 shadow-md object-cover"
                        />
